...
FILE_NAME = "results/zfs/checkpoint/benchbase_long_pause_inbetween_tests/test_result_1636426087.3657014.json_42G"
...
def main():
    ...
    print(df[TOTAL_TIME])
    valid_measurements.plot(x=BENCHBASE_ITERATION, y=sec_measurements, kind="bar",
