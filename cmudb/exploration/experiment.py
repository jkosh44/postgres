...
def test_copy() -> Tuple[int, int, int, int, int, int, bool, str, int, int]:
    ...
    precheckpoint_dirty_pages = execute_sql("SELECT COUNT(*) FROM pg_buffercache WHERE isdirty = 't'", REPLICA_PORT)
    ...
    postcheckpoint_dirty_pages = execute_sql("SELECT COUNT(*) FROM pg_buffercache WHERE isdirty = 't'", REPLICA_PORT)
